...
call s:add_hi('DiffAdd', NONE, GREEN, NONE)
call s:add_hi('DiffChange', NONE, ORANGE_DARK, NONE)
call s:add_hi('DiffDelete', NONE, RED_DARK, NONE)
call s:add_hi('DiffText', FG, PURPLE, BOLD)

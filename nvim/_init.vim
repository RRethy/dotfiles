...
" set nocursorline " Changes colour of row that cursor is on
...
" set signcolumn=number " max 3 width sign column
...
" augroup rrethy
" 	autocmd!
" 	autocmd FileType scala lua require'lsp_setup'.scala()
" 	autocmd FileType scala lua require'metals'.initialize_or_attach({})
" augroup END
...
"     autocmd!
"     autocmd TextYankPost * lua require'vim.highlight'.on_yank({timeout=250})
" augroup END
...
" let g:loaded_illuminate = 1 " Using lua require'illuminate'.on_attach(client)
...
" let g:Hexokinase_ftDisabled = ['css', 'vim']
...
"     autocmd!
"     " autocmd FileType dart call s:alef()
" augroup END
